...
## BenTheCyberOne Edit
This library contained a handful of issues when attempting to communicate with the PN532s that we had ordered for this badge. A few classes have been altered in order to get Peer-to-Peer communication working between two badges. There may be much better fixes to some of these functions but it works and that is what matters :)
